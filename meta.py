...
class MetaData:
    ...
    def Init_UI(self):
        ...
        self.browse_excel_button_1.place(x=100,y=370)
        ...
        self.browse_excel_button_2.place(x=550,y=370)
        ...
        self.browse_log_button.place(x=325,y=650)
        ...
        self.confirm_button.place(x=325,y=750)
